...
def test_search_transactions_action():
    ...
    with patch('builtins.input', return_value='Аптеки'), \
            patch('main.read_operations') as mocked_read_operations, \
            patch('main.search_transactions_service') as mocked_search_transactions_service, \
            patch('builtins.print') as mocked_print:
